        ...
        for line2 in ('{}'.format(temp['text'])): #line2は一文字　イギリスの本文記事数が37013
            ...
            if flag0 == 1:
                ...
                if (flag == 1 and str_count != 1) or b_flag == 1:
                    ...
                    ####################26,27
                    if line2 != '\'' and  flag5 != 1 and line2 != '{' and line2 != '}' and line2 != '[' and line2 != ']':
                        moji = moji + line2
...
###############[[[[[[[[[[[[[[[[[[[[[2 9]]]]]]]]]]]]]]]]]]]]]###############
#wikiAPIのimageinfoを呼び出してurlを取得すればよい.

UK_flag = 'File:' + dic['国旗画像']
UK_flag = UK_flag.replace(' ', '%20')


url = "https://www.mediawiki.org/w/api.php?action=query&prop=imageinfo&iiprop=url&format=json"
url = url + '&titles=' + UK_flag
